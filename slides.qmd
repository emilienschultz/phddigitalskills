...
- The file system is a tree 🌲
   - **Absolute path** : from the root
       - It depends of the specific computer
...
Commands have a global pattern

![](./img/shell_command_syntax.svg)
...
::: {.callout-tip}
## Download the file with the command in the README
``` bash
...
::: {.callout-tip}
## Find all files that mention your discipline
:::
...
::: {.callout-tip}
## Get the line in the jsonl file for a picture with grep
:::
...
``` bash
find img -name "*sociology*"
``` 
:::

::: {.callout-tip}
## Get the line in the jsonl file for a picture with frep
``` bash
...
![](./img/git_commit_2x.png){height=800 fig-align="center"}
...
![](./img/gittotal.png){height="800px" fig-align="center"}
